...
Haremos un pequeño ejemplo con una aplicación **Open-Source** llamada [Helpet](https://helpet.codenity.org) de nuestros amigos de [Codenity](https://www.codenity.org). Su repositorio lo puedes revisar [aqui](https://github.com/CodenityOrg/helpet-FE)
...
Aqui otro ejemplo sencillo de componentes funcionales que puedes revisar! 😀
